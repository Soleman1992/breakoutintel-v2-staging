...
const FALLBACK_TICKERS = {
  ...
  LARGECAP: [
    ...
    'AMBUJACEM','ACC','SHREECEM','VEDL','TATAPOWER','ADANIGREEN','ADANITRANS',
  ...
  MIDCAP: [
    ...
    'CAMS','KFINTECH','CDSL','MCX','ANGELONE','ROUTE','MFSL','STARTIND',
    'PGHH','MANAPPURAM','CREDITACC','UJJIVANSFB','EQUITASBNK','AAVAS','REPCO',
    'SOBHA','BRIGADE','PRESTIGE','PHOENIX','NESCO','SAFARI','VGUARD',
    'BALAMINES','DEEPAKNI','FLUOROCHEM','CLEAN','SEQUENT','IOLCP','JKCEMENT',
    'BIRLAMONEY','FINPIPE','NBCC','HUDCO','RAILVIKAS','RVNL','IRB','NHAI',
